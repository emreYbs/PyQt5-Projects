...
# Install the required libraries/modules if you don`t have them: pip install PyQt5 
...
class TabWidget(QTabWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("MarkDownGuide")
        self.setWindowIcon(QIcon('/home/emre/Downloads/MarkDown_icon.png'))#ChangeAccordingtoYourUserNameAndPATH
        self.setTabsClosable(True)
        self.tabCloseRequested.connect( self.close_current_tab )
        self.setDocumentMode(True)
        width = 600 # You can play with this setting according to your screen, resolution if it is too small for you.
        height = 500
        self.setMinimumSize(width, height)
        baseurl = "https://www.markdownguide.org/basic-syntax"
        url = QUrl((baseurl))
