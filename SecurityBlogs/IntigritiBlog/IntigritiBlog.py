...
# For infoSec related people, this blog_(https://blog.intigriti.com)_ is a lovely resource for bug hunters.
...
class TabWidget(QTabWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowTitle("intigriti blog for bug hunters")
        self.setWindowIcon(QIcon('/home/emre/Downloads/intigritiLogo.png'))#ChangethePATH if you want to use a icon for the GUI.
        ...
        baseurl = "https://blog.intigriti.com" 
        url = QUrl((baseurl))
